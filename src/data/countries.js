/* ISO 3166-1 alpha-2 codes (lowercase) + display names.
   Flags are served from flagcdn.com by code, e.g.
   https://flagcdn.com/w40/us.png  /  https://flagcdn.com/w80/us.png (2x)
   The `code` is what gets stored on the pilot so a ship model can later
   attach the matching flag. */
